    ...
    function checkCollisions() {
        ...
        for (var i = 0; i < allEnemies.length; i++) {
            var enemy = allEnemies[i],
                // 从上往下数第一条路
                case1 = (enemy.x + 101 - precision) >= player.x && (enemy.x <= player.x + 101 - precision) && enemy.y === 60 && player.y === 58,
                // 从上往下数第二条路
                case2 = (enemy.x + 101 - precision) >= player.x && (enemy.x <= player.x + 101 - precision) && enemy.y === 145 && player.y === 141,
                // 从上往下数第三条路
                case3 = (enemy.x + 101 - precision) >= player.x && (enemy.x <= player.x + 101 - precision) && enemy.y === 230 && player.y === 224;
